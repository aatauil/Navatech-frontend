...
function Landing() {
    ...
    return (
        <article className="p-3 pt-20 md:py-24 w-screen">
            ...
            <div className="w-4/5 md:w-2/4 ">
                ...
                <div className="bg-white shadow p-6 mt-6 w-full md:w-3/5">
            ...
            <div className="hidden w-2/4 md:flex justify-center items-center">
                <img className="w-3/5" src={"http://localhost:1337" + data.landingPage.Image.url}></img>
            </div>
